...
const pages = [['Home','/'], ['About Us','/about'], ['Courses','/courses'],['My Courses','/courses/purchased']];
const settings = ['Profile', 'Account', 'Dashboard', 'Logout'];

function NavBar() {
  const {logout, queryApi,setUser}=userActions()
  const [username,setUsername] = useRecoilState(usernameVal)
  const token = useRecoilValue(tokenVal)
  let navigate=useNavigate()

  React.useEffect(() => {
          
      // let queryUser= async()=>{try{
